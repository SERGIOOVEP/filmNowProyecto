...
export const GenerateFilms = () => {
    ...
    const url = `https://imdb-api.com/en/API/YouTubeTrailer/${token5}`
    //Traemos del local las respuestas seleccionadas por el usuario
    ...
    useEffect(() => {
        ...
        fetch(`https://imdb-api.com/es/API/AdvancedSearch/${token5}/?genres=${genres}`)
            ...
            pelis.forEach(peli => {
                if (peli.runtimeStr) {
                    ...
                    switch (answerSelection) {
                        ...
                        default: console.log("no hay peliculas de esa duración")
                    }
                }
            ...
            pelis.forEach(peli => {
                if (peli.imDbRating) {
                    ...
                    switch (answerSelection) {
                        ...
                        default: console.log("no hay peliculas con esa nota")
                    }
                }
